...
ActiveRecord::Schema.define(version: 20140408214238) do
  ...
  add_index "file_imports", ["user_id"], name: "index_file_imports_on_user_id", using: :btree
  ...
  add_index "purchases", ["file_import_id"], name: "index_purchases_on_file_import_id", using: :btree
